...
class HermesDaemonRuntime:
    ...
    async def command(self, action: str, request: Mapping[str, Any]) -> Mapping[str, Any]:
        ...
        from .native_control import NATIVE_SESSION_CONTROL_ACTIONS

        if action in NATIVE_SESSION_CONTROL_ACTIONS:
            from .native_control import execute_native_session_control
        ...
        if action == "session.rename":
            ...
            from astrorder.native.session_mutation import rename_native_session
        ...
        if action == "session.delete":
            ...
            from astrorder.native.session_mutation import delete_native_session
