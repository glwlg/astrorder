...
import { IconChevronDown, IconChevronRight, IconPin, IconPinned, IconPlus } from '@tabler/icons-react'
...
export function MobileSessionDrawer({ groups, pins, selectedKey, appearance, onSelect, onPin, onCreate }: {
