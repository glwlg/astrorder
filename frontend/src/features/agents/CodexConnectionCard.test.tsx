...
it('connects then reads back native status before showing connected', async () => {
  let state: CodexConnectionStatus = { kind: 'codex', state: 'disconnected', available: true, agent_id: 'local-codex', session_count: 0, auth_required: false, detail: 'ready to connect' }
